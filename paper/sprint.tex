...
\begin{abstract}
\noindent
An installed persona changes how a model writes. Does it change what the model
prefers? Preference-coherence fits a Thurstonian model to pairwise choices; a
...
of \MeanResidual{}. \NFailsFloor{} of \NModels{} do not clear their own
replicate floor. Conviction collapses \MedianDecisiveRatio$\times$ on nonsense;
direction barely moves. A discarded channel separates the arms at AUROC
\DetBestAuroc{}, against \DetKeptAuroc{} for the channel the metric keeps.
