...
% Same finding-named title as the paper, shortened for a slide: the paper's
% subtitle carries the hedge in a second clause that does not fit here, and the
% floor number is the half an audience repeats.
\title{Coherence Without Content}
\subtitle{A value-coherence metric scores invented outcomes at \MeanFloor{}}
\author{Nullcard}
