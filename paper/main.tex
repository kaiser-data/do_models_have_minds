...
\large Replace every outcome with invented words, and what a model appears to
prefer\\ barely changes --- at every size we measured, from under a billion
parameters\\ to the largest open models we could reach. A high
preference-coherence score\\ is therefore not evidence that the model
