...
\paragraph{What is actually refuted is an inference, not a mind.}
Assessing AI systems for morally relevant states is a live proposal
\citep{long2024welfare}; this paper is about the instruments such an assessment
would use. The claim
...
\paragraph{The same failure on the instrument people trust most: asking.}
\citet{perez2023selfreports} propose self-reports as a route to evaluating AI
systems for moral status while noting that current ones are spurious;
\citet{lindsey2025introspection} finds limited introspective access where ground
truth is supplied by activation injection. The
